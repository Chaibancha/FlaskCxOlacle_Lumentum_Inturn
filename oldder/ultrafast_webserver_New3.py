...
def showSignUp():
    ...
    for item in deduplicated.values():
        ...
        #     sections[section_title].append(section_item)
        # else:
        #     sections[section_title] = [section_item]
    ...
    return render_template('signup_new_04.html',all_header_per_sn_list = all_header_per_sn_list
