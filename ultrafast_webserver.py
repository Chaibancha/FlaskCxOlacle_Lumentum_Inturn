...
def main():
    ...
    return render_template('index_list_ultra.html', list_of_sorted_bench_executions=list_of_sorted_bench_executions,
                           ...
                           length_of_last_tested=length_of_last_tested, 
                           last_tested_dict=last_tested_dict, 
                           dates_execution_dict=dates_execution_dict, 
                           dict_of_models_in_dict_of_dates=dict_of_models_in_dict_of_dates, 
                           list_of_last_week_dates=list_of_last_week_dates,
...
def showSignUp():
    ...
    #return render_template('signup_ultrafast.html',all_header_per_sn_list = all_header_per_sn_list, serial_num = ser_num)

if __name__ == "__main__":
    app.secret_key = 'super secret key'
    app.run(host="0.0.0.0", port=port_flask, threaded=True,debug=True)